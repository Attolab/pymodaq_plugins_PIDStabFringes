...
class DAQ_Move_StabSpectro(DAQ_Move_base):
    """
    ...
    is_multiaxes = True
    stage_names = StabSpectroController.axis
    _epsilon = 1
    ...
    def ini_stage(self, controller=None):
        ...
        try:
            ...
            if self.settings.child('multiaxes', 'ismultiaxes').value() and self.settings.child('multiaxes',
                ...
                self.controller = StabSpectroController()  # any object that will control the stages
